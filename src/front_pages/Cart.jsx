...
function Cart() {
  ...
  const updateCartItem = async (cart_id, item_id, qty) => {
    ...
    setIsScreenLoading(true);
    try {
      await axios.put(`${baseUrl}/api/${apiPath}/cart/${cart_id}`, itemData);
      gettingCartList();
    } catch (error) {
              ...
              <div className="col-md-4">
                <div className="border p-4 mb-4">
                  ...
                  <div className="mt-3">
                    ...
                    <ul>
                      <li>
                        下單前請再次仔細核對訂單內容，確保甜點是您需要的數量。
                      </li>
                      <li>
                        付款方式：自取僅限到店支付現金，宅配則使用銀行轉帳，需直接到海神甜點劇場的 Facebook 私訊聯絡取得帳號，恕不接受其他付款方式，敬請見諒。
                      </li>
                    </ul>
                  </div>
                </div>
